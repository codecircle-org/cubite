...
export async function GET(request: NextRequest, response: NextResponse) {
  try {
    ...
    const facebookClientId = site.ssoProviders?.facebookClientId;
    const facebookClientSecret = site.ssoProviders?.facebookClientSecret;
    const accessTokenResponse = await fetch(accessTokenUrl, {
      ...
      body: JSON.stringify({
        ...
        redirect_uri: `${
          process.env.NODE_ENV === "development" ? "http://" : "https://"
        }${hostname}/api/authentication/callback/facebook`,
