...
const CourseCardParley = ({ course, site }) => {
    ...
    <div className="grid border border-primary-200 shadow-md rounded-sm bg-base-200/40">
      <Link key={course.id} className="" href={`/course/${course.id}/about/`}>
        <div className="relative h-52 w-42">
          ...
          <div className="absolute bottom-0 left-0 m-4">
            <div className="">
              ...
              <p className="text-xl font-semibold text-primary-content mx-1 my-2">
                {course.name}
              </p>
            </div>
        ...
        <div className="border-b space-y-4">
          <p className="text-md font-light text-base-content/80 my-4 border-b border-primary-200 p-4">
            {course.price > 0 ? (
              ...
              <p className="text-md font-semibold mb-2">Free Access</p>
            )}
            {course.description
              ? course.description
...
export default CourseCardParley;
